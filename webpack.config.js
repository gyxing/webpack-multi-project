...
module.exports = function(env) {
    ...
    if(project_name) {
        ...
        if(!fs.existsSync(project_dir)) {
            ...
            // 子项目的配置文件
            fs.appendFileSync(`${project_dir}/config.js`, templateConfig.addConfigJS(project_root_name, project_name));
            // 入口文件
            fs.appendFileSync(`${project_dir}/src/App.vue`, templateConfig.addAppVue());
